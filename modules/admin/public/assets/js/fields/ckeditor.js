	...
	function initItem() {
        ...
        function initialise() {
        	...
        	var config = {
        		...
        		bodyClass: 'editor',
        		contentsCss: [CMF.baseUrl + '/admin/assets/css/ckeditor-contents.css', CMF.baseUrl + '/admin/assets/ckeditor/contents.css'],
        		filebrowserBrowseUrl: CMF.baseUrl + '/admin/finder/browser?start=files',
        		filebrowserImageBrowseUrl: CMF.baseUrl + '/admin/finder/browser?start=images',
