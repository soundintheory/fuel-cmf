    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createUl = function(is_root_node) {
        ...
        if (is_root_node) {
          ...
          class_string = ' class="jqtree-children"';
        }
      ...
      createNodeLi = function(node) {
        ...
        return $("<li class=\"jqtree-node\"><div class=\"main\"><span class=\"jqtree-title\">" + escaped_name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        ...
        return $("<li class=\"jqtree-node " + folder_classes + "\"><div class=\"main\"><a class=\"" + button_classes + "\">" + button_char + "</a><span class=\"jqtree-title\">" + escaped_name + "</span></div></li>");
      };
  ...
  DragAndDropHandler = (function() {
    ...
    DragAndDropHandler.prototype.generateHitAreas = function() {
      ...
      handleOpenFolder = function(node, $element) {
        if (node === _this.current_item.node) {
          addPosition(node, Position.NONE, getTop($element));
          return false;
        }
