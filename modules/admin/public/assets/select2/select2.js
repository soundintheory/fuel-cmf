...
Version: 3.3.1 Timestamp: Fri 22 Feb 2013 10:40:30 GMT
...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        getPlaceholder: function() {
            ...
            if (this.select && this.opts.alwaysShowPlaceholder !== true) {
        ...
        setPlaceholder: function () {
            ...
            if ((this.opts.alwaysShowPlaceholder === true || this.opts.element.val() === "") && placeholder !== undefined) {

                // check for a first blank option if attached to a select
                if (this.opts.alwaysShowPlaceholder !== true && this.select && this.select.find("option:first").text() !== "") return;
