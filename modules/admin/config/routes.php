...
return array(
	...
	'admin/install'           => 'admin/install',
        'admin/forgotpassword'    => array(array('GET', new Route('admin/auth/forgotpassword')), array('POST', new Route('admin/auth/submit_forgot'))),
        'admin/resetpassword'    => array(array('GET', new Route('admin/auth/resetpassword')), array('POST', new Route('admin/auth/submit_reset'))),
	...
	'admin/(:segment)/deleteall'                => 'admin/list/deleteall/$1',
	'admin/(:segment)/import'                   => 'admin/import/index/$1',
	'admin/(:segment)/import/(:segment)'        => 'admin/import/$2/$1',
