...
return array(
	...
	'admin/qrcode/(:segment)'	=> 'admin/auth/serve_qrcode/$1',
    ...
    'admin/(:segment)/action/(:segment)'        => 'admin/list/action/$1/$2',
    'admin/(:segment)/action/(:segment)/(:segment)'  => 'admin/list/action/$1/$2/$3',
