...
class GridInline extends Multiselect {
    ...
    public static function displayForm($value, &$settings, $model)
    {
        ...
        return array(
            'assets' => $assets,
            'content' => strval(\View::forge('admin/fields/collection/grid-inline.twig', array( 'settings' => $settings, 'add_types' => $add_types, 'icon' => $target_class::icon(), 'singular' => $target_class::singular(), 'plural' => $target_class::plural(), 'rows' => $rows, 'templates' => $templates_content, 'forms' => $form_templates, 'sortable' => $sortable ), false)),
            'widget' => false,
            'widget_class' => '',
