...
class Model_Page_Home extends Model_Page_Base
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Model_Layout1slide",orphanRemoval=true)
     * @ORM\JoinTable(name="layout1_slides_homepage_mapping")
     */
    protected $layout1slides;
     ...
     * @ORM\Column(type="text", nullable=true)
     **/
    protected $second_section_intro;
